...
abstract class AppLocalizations {
  ...
  /// No description provided for @operationIncrease.
  ///
  /// In en, this message translates to:
  /// **'increase'**
  String get operationIncrease;

  /// No description provided for @operationDecrease.
  ///
  /// In en, this message translates to:
  /// **'decrease'**
  String get operationDecrease;

  /// No description provided for @operationReset.
  ///
  /// In en, this message translates to:
  /// **'reset'**
  String get operationReset;
}
